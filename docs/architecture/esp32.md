...
> reference: the [WebSocket API guide](https://github.com/locveil/locveil-voice/blob/main/docs/guides/websocket-api.md),
> owned by locveil-voice and pinned by this repo — see `contracts/README.md`). What's left is
...
That same room/device identity is what the smart-home layer addresses
([MQTT](https://github.com/locveil/locveil-voice/blob/main/docs/architecture/mqtt.md)), and what a
